...
public class N113_맵항목치환 {
    public static void main(String[] args) {
        ...
        mapOfMelon.put(1, new Melon(1000));
        mapOfMelon.put(2, new Melon(2000));
        mapOfMelon.put(3, new Melon(3000));
        Melon melon = mapOfMelon.replace(2, new Melon(4000)); //기존에 들어있던 2000 멜론을 변수에 담음
        System.out.println(melon.toString());

        //2. 2번째 아규먼트의 값이 일치할때, 치환하고 성공하면 True, 실패하면 Fasle
        boolean melon2 = mapOfMelon.replace(3, new Melon(3000), new Melon(5000));

        //3. 무게가 1000 이상인 것들을 1000으로 치환
        BiFunction<Integer, Melon, Melon> function = (k, v)
                -> v.getWeight() > 1000 ? new Melon(1000) : v;
